-- INSERT INTO app_role (id, role_name, description) VALUES (1, 'STANDARD_USER', 'Standard User2 - Has no admin rights');
-- INSERT INTO app_role (id, role_name, description) VALUES (2, 'ADMIN_USER', 'Admin User2 - Has permission to perform admin tasks');
--
-- -- USER
